class UsersController < ApplicationController
  skip_before_action :require_login, only: [:new, :create]
    ...
    def show
        ...
        # @record = Contact.where(user_id: params[:id])
      ...
      def add
        ...
        p "My contact id is: #{add_user.id}"
        @link = Contact.where(user_id: current_user, frien_id: add_user.id)
        redirect_to :back
      end
    def destroy
        # Log User out
